...
if __name__ == "__main__":
    ...
    empty_label_in_frame = Frame.add_label_on_frame(datetime_label_in_frame, " / ", None, 1, 0, 1)
    date_label_in_frame = Frame.display_date_on_frame(datetime_label_in_frame, 1, 0, 2)

    notepad_frame = Frame(gui.add_label_frame("Notepad", 1, 1, 2, 0, 10, 2, 2))
    ...
    chatbot_switch_frame = Frame(gui.add_label_frame("Mini-ChatBot", sf_row_span, sf_column_span, sf_row, sf_column,
    ...
    chatbot_button = Frame.add_button_on_frame(nav_button_frame, "Mini-Chatbot",
                                               lambda: GUI.switch_frame(chatbot_switch_frame, all_switch_frames), 0, 1,
                                               nav_button_cur, 4, 4)
